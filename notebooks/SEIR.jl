...
# ╔═╡ d1427010-a5d6-11ed-3508-4141b4211adb
using DifferentialEquations, Plots, PlutoUI


# ╔═╡ cc19bcc9-1b3f-45aa-b167-853708b43bd7
...
# ╔═╡ e3304744-8feb-483d-b008-5abb900640d9
init=[0.8,0.1,0.1];

# ╔═╡ 2f4924bd-9a29-4e43-a870-4c52171eca53
tspan=(0.0,365.0);

# ╔═╡ 69f7abf1-11f7-4675-a854-7fe3c17e56b3
begin
	β_slider = @bind β Slider(0:.01:1)
	σ_slider = @bind σ Slider(0:.001:.1)
	γ_slider = @bind γ Slider(0:.001:.1)
	μ_slider =@bind μ Slider(0:.001:.1)
	md"""
	**parameters**
...
# ╔═╡ bb82ada9-858e-434a-9db0-d186a4e9eeea
par=[β, σ, γ, μ];

# ╔═╡ ca332386-9eb4-4adb-baf0-cff68714142b
prob = ODEProblem(seir_ode, init, tspan, par);

# ╔═╡ 2dc7e2ba-b81a-4800-80f1-7a68eb6bf82b
(sol = solve(prob));

# ╔═╡ 372cd8c5-9fd1-41d9-8945-68fbc252c61d
R=ones(1,size(sol,2))- sum(sol, dims = 1);

# ╔═╡ 9d0c524c-4f63-4d63-85de-783cb29ce73f
plot(sol.t, [sol', R'], label = ["S" "E" "I" "R"])
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "1535a0387f4037324186a1918669b838163cf81f"
...
git-tree-sha1 = "38562b659fc155a5425aa4549980090baac02fcb"
