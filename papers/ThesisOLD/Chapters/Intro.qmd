...
@allen2015StochasticPopulationEpidemic

## Refresher on Markov Chains

## Examples of Markov chain representations of Compartmental Models
...
The probability of being in state $i$ at time $t + \Delta t$ can be expressed in terms of probabilities at time $t$. $$
p_{i}(t + \Delta t) =
