...
$$ thus for the row $M_{i}$, representing the mixing of individuals from Kensington, $ sum\limits_{j}M_{j}= \frac{1}{4} +\frac{1}{8} + \frac{1}{8} +\frac{1}{8} + \frac{1}{8} + \frac{1}{8} + \frac{1}{8} = 1$ as desired. Repeating this for all patches $i$, gives the mixing matrix represented in @fig-egMM
