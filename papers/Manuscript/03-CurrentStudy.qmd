...
$$ Where $P_{tot}$ is the total number of patches. - How should we interpret this mixing coefficient? \### Population proportional mixing
...
```{r}
#| label: fig-GCC_HMM
#|  caption: Hierarchical Mixing matrices for the Greater Melbourne Capital City Statistical Area (GMGCCSA)
#| echo: false
#| warning: false
GMelb_Shapes[3:5] %>%
  map(Hmixmat) %>% 
